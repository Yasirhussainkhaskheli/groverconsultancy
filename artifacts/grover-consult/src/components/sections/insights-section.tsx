...
export function InsightsSection() {
  ...
  const displayData = insights && insights.length > 0 ? insights.slice(0, 3) : [
    {
      id: 1,
      title: "The Future of AI in Enterprise Decision Making",
      category: "Digital Transformation",
      excerpt: "How forward-thinking executives are moving beyond generative AI experiments to core systemic implementations that drive real ROI.",
    ...
    },
    {
      ...
      excerpt: "Strategies for aligning marketing, technology, and sales teams to accelerate deal velocity and improve win rates.",
    ...
    },
    {
      ...
      excerpt: "Key lessons from successful core banking transformations. Minimizing risk while accelerating the transition to agile infrastructure.",
