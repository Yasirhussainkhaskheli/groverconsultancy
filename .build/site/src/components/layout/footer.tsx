      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          <div className="col-span-1 lg:col-span-1">
            <a href={toStaticHref(basePath)} className="flex items-center gap-1.5 mb-6 outline-none">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                <a href={toStaticHref(`${basePath}services/digital-transformation-consulting`)} className="text-muted-foreground hover:text-primary transition-colors text-sm flex items-center gap-2">
                  <ChevronRight className="w-3 h-3 text-primary" /> Digital Transformation Consulting
                </a>
              </li>
              <li>
                <a href={toStaticHref(`${basePath}services/core-banking-implementation`)} className="text-muted-foreground hover:text-primary transition-colors text-sm flex items-center gap-2">
                  <ChevronRight className="w-3 h-3 text-primary" /> Core Banking Implementation
                </a>
              </li>
              <li>
                <a href={toStaticHref(`${basePath}services/sales-enablement-consulting`)} className="text-muted-foreground hover:text-primary transition-colors text-sm flex items-center gap-2">
                  <ChevronRight className="w-3 h-3 text-primary" /> Sales Enablement Consulting
                </a>
              </li>
              <li>
                <a href={toStaticHref(`${basePath}services/system-integration-implementation`)} className="text-muted-foreground hover:text-primary transition-colors text-sm flex items-center gap-2">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                <a href={toStaticHref(`${basePath}philippines`)} className="text-muted-foreground hover:text-primary transition-colors text-sm flex items-center gap-2">
                  <ChevronRight className="w-3 h-3 text-primary" /> Philippines
                </a>
              </li>
              <li>
                <a href={toStaticHref(`${basePath}indonesia`)} className="text-muted-foreground hover:text-primary transition-colors text-sm flex items-center gap-2">
                  <ChevronRight className="w-3 h-3 text-primary" /> Indonesia
                </a>
              </li>
              <li>
                <a href={toStaticHref("/#partners")} className="text-muted-foreground hover:text-primary transition-colors text-sm flex items-center gap-2">
                  <ChevronRight className="w-3 h-3 text-primary" /> Solution Partners
                </a>
              </li>
              <li>
                <a href={toStaticHref("/#clients")} className="text-muted-foreground hover:text-primary transition-colors text-sm flex items-center gap-2">
        ...
        <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-muted-foreground text-sm">
            © {CURRENT_YEAR} Grover Consult. All rights reserved.
          </p>
          <div className="flex gap-6 text-sm text-muted-foreground">
            <a href={toStaticHref(`${basePath}privacy`)} className="hover:text-primary transition-colors">Privacy Policy</a>
            <a href={toStaticHref(`${basePath}terms`)} className="hover:text-primary transition-colors">Terms of Service</a>
          </div>
        </div>
      </div>
    </footer>
