 ...
 */
export const getGetInsightByIdUrl = (id: number) => {
...
export const getInsightById = async (
  ...
  return customFetch<Insight>(getGetInsightByIdUrl(id), {
    ...options,
    method: "GET",
  });
};

export const getGetInsightByIdQueryKey = (id: number) => {
  return [`/api/insights/${id}`] as const;
};

export const getGetInsightByIdQueryOptions = <
  TData = Awaited<ReturnType<typeof getInsightById>>,
  TError = ErrorType<Error>,
>(
  id: number,
  options?: {
    query?: UseQueryOptions<
      Awaited<ReturnType<typeof getInsightById>>,
      TError,
      TData
    >;
    request?: SecondParameter<typeof customFetch>;
  ...
  const queryKey = queryOptions?.queryKey ?? getGetInsightByIdQueryKey(id);

  const queryFn: QueryFunction<Awaited<ReturnType<typeof getInsightById>>> = ({
    signal,
  }) => getInsightById(id, { signal, ...requestOptions });
...
export type GetInsightByIdQueryResult = NonNullable<
  Awaited<ReturnType<typeof getInsightById>>
>;
export type GetInsightByIdQueryError = ErrorType<Error>;

/**
 * @summary Get a single insight by ID
 */

export function useGetInsightById<
  TData = Awaited<ReturnType<typeof getInsightById>>,
  TError = ErrorType<Error>,
>(
  id: number,
  ...
  const queryOptions = getGetInsightByIdQueryOptions(id, options);
